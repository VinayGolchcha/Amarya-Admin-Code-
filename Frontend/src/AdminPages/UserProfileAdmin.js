...
const UserProfileAdmin = () => {
  ...
  const handleUserUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_URL}/user/update-user-profile/${filterEmpId}`,
        formDataToSend,
        {
          headers: {
    ...
    return (
      <Box>
        ...
        >
          ...
          >
            <FormControl sx={{ minWidth: 220, mt: "10px" , marginBottom : "20px" }}>
              <InputLabel
                ...
                {isEditing && (
                  <Box sx={{width : "100%" , display : "flex" , justifyContent : "end"}}>
                    <Button
                      ...
                      variant="contained"
                      sx={{ marginTop: "20px" , marginRight : "10px",backgroundColor: "#FF5151", fontSize : "0.8rem", fontFamily : "Poppins", color : "white" ,  textTransform : "none" ,width : {lg: "20%" , md : "40%"},cursor : "pointer" , boxShadow: "0px 4px 6px -1px #FF5151", "&:hover" : {
