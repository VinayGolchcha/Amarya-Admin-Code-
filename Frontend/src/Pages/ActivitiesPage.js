                ...
                <Grid container spacing={1}>
                    {activities.map((activity, index) => (
                        <Grid key={activity.id} item xs={12} sm={12} md={6} lg={3}>
                            <Box sx={{
                                display: 'flex', flexDirection: index % 2 === 0 ? 'column' : 'column-reverse', [theme.breakpoints.down('md')]: {
                                ...
                                <Link to={`/activities/${activity.id}`}>
                                    ...
                                    >
                                        <Slider {...sliderSettings} sx={{ minHeight: '300px', height: '100%', }}>
                                            {activity.images.map((image, index) => (
                                                <div key={index} style={{ minHeight: '300px', height: '100%', }}>
                                                    <img
                                                        src={image}
                                                        alt={`Slide ${index}`}
                                                        style={{
                                                            ...
                                                            display: 'block',
                                                            position: 'relative',
                                                            opacity: hoveredCard === activity.id ? '0.6' : '1',
                                ...
                                <Card
                                    ...
                                    style={{
                                        ...
                                        border: 'solid 1px #74787e',
                                        borderRadius: '0',
                                        transform: isCardFlipped(activity.id) ? 'rotateY(180deg)' : 'rotateY(0)',
                                ...
                                >
                                    <CardContent style={{
                                        ...
                                        width: '300px',
                                        height: '300px',
                                        transform: isCardFlipped(activity.id) ? 'rotateY(180deg)' : 'rotateY(0deg)',
                                    }}>
                                        {
                                            isCardFlipped(activity.id) ? (
                                                <Box sx={{ padding: '0px 10px', display: 'flex', flexDirection: 'column' }}>
                                                    <Typography variant="h5" component="div" color='#121843'>
                                                        {activity.title}
                                                    </Typography>
                                                ...
                                                < Box sx={{ width: '100%', height: '100%', padding: '0px 10px', display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }}>
                                                    <Typography variant="caption" color='#74787e' sx={{ fontWeight: '700' }}>
                                                        {activity.date}
                                                    </Typography>
                                                    <Typography variant="h3" component="div" color='#121843'>
                                                        {activity.title}
                                                    </Typography>
                                                    <Typography variant="caption" sx={{ fontWeight: '700' }} color='#74787e'>
                                                        Read more.....
                                                    </Typography>
                                                </Box>
                                            )
